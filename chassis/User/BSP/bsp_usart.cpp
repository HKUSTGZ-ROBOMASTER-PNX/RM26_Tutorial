...
static uint8_t UART6RxBuffer[VT03_DATA_SIZE] = {0};
static uint8_t UART3RxBuffer[DR16_DATA_SIZE] = {0};
...
void USART3_IRQHandler(void)
{
  ...
  else if (USART3->SR & UART_FLAG_IDLE)
  {
    ...
    if ((hdma_usart3_rx.Instance->CR & DMA_SxCR_CT) == RESET)
    {
      ...
      {
        memcpy(Dr16::Instance()->Dr16_Data.ReceiveBuffer, SBUS_rx_buf[0], DR16_DATA_SIZE);
        Dr16::Instance()->AliveFlag ++;
      }
    }
    else
    {
      ...
      if (current_rx_len == DR16_DATA_SIZE)
      {
        memcpy(Dr16::Instance()->Dr16_Data.ReceiveBuffer, SBUS_rx_buf[1], DR16_DATA_SIZE);
        Dr16::Instance()->AliveFlag ++;
      }
    }
  }
